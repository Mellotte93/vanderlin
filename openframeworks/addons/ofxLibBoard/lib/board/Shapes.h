...
struct Rectangle : public Polyline {
  ...
  Point topLeft() { return Point( _points[0].x, _points[0].y ); }
  Point topRight() { return Point( _points[1].x, _points[1].y ); }
  Point bottomLeft() { return Point( _points[3].x, _points[3].y ); }
  Point bottomRight() { return Point( _points[2].x, _points[2].y ); }
