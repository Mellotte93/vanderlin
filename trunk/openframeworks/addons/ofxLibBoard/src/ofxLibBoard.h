...
#define PIXEL_TO_MM 3.779527559
...
public:
	...
	//----------------------------------------------------------
	void setColor(int _r, int _g, int _b, int _a=255.0);
	void setColor(int hexColor);
	void changeColor(float r, float g, float b, float a=1.0);
