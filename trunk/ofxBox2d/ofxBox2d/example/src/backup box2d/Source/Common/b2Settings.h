...
const int32 b2_maxProxies = 65536;//8192;//4096;//512;				// this must be a power of two
const int32 b2_maxPairs = 32 * b2_maxProxies;	// this must be a power of two
//const int32 b2_maxPairs = (b2_maxProxies >> 1) * b2_maxProxies;
